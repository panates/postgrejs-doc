...
- **Cursors** — Fast double-linked cache cursors for efficient data retrieval. See [Cursors](../querying/cursors.md).
...
- **Notifications** — High-level implementation for PostgreSQL notifications (LISTEN/NOTIFY), enabling real-time data updates. See [Notifications](../realtime/notifications.md).
- **Extensibility** — Extensible data types and type mapping to accommodate custom requirements. See [Data Types & Type Mapping](../querying/data-types.md).
