      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              html: `<a href="https://github.com/panates/sqb" target="_blank" rel="noopener noreferrer" class="footer__link-item" style="display:inline-flex;align-items:center;gap:6px"><img src="/img/sqb-logo.svg" width="14" height="14" alt="SQB" style="border-radius:2px"/>SQB</a>`,
            },
            {
